    ...
    >
      <Popover open={open} onOpenChange={setOpen} modal={false}>
        <PopoverTrigger asChild>
          <div
            className={cn(
              'after:absolute after:inset-0 after:z-1 after:h-[calc(100%)+4px] after:w-[calc(100%+8px)] after:rounded-sm after:content-[""]',
              'h-6',
        ...
        <EquationPopoverContent
          ...
          className="my-auto"
          placeholder="Add a Tex equation, press Enter to save"
          setOpen={setOpen}
        />
      </Popover>
