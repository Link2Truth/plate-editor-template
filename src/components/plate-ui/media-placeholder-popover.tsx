    ...
    <Popover open={open} onOpenChange={setOpen} modal={false}>
      ...
      >
        <Tabs className="w-full shrink-0" defaultValue="account">
          ...
          <TabsContent className="w-full px-3 py-2" value="account">
            <Button className="w-full max-w-[300px]" onClick={openFilePicker}>
          ...
          <TabsContent
            className="w-full px-3 pt-2 pb-3 text-center"
            value="password"
          >
            <Input
              value={embedValue}
